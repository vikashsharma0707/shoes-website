...
const Productdisplay = () => {
  ...
  return (
    <>
      ...
      <div id="data">
        <div>
          <img src={mypro.images} alt={mypro.name} style={{ width: "400px", height: "600px" }} />
        </div>
        ...
        <div>
          ...
          <h2>{mypro.discription}</h2>
          <h2>{mypro.price}</h2>
          <button onClick={() => Datacart(mypro.id, mypro.name, mypro.discription, mypro.price, mypro.images)}>
            Add to cart
          </button>
        </div>
      </div>
